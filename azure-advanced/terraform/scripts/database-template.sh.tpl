...
GRANT ALL ON analytics_db.* TO analytics_user@'%' IDENTIFIED BY "$USER_PASSWORD";
...
mysql -s  <<EOF  > $LOG_DIRECTORY/query.log -h $CONNECTION_STRING -u analytics_user@wso2apimdb -p$USER_PASSWORD

USE analytics_db;
SOURCE $DB_HOME/mysql-analytics.sql
